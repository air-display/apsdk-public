...
namespace aps { namespace service { 
    ap_audio_stream_session::ap_audio_stream_session(asio::io_context& io_ctx, aps::ap_crypto& crypto)
    ...
    ap_audio_stream_service::ap_audio_stream_service(aps::ap_crypto& crypto, uint16_t port)
