...
uint8_t
plist_object_get_type(const plist_object_t *object)
{
    if (!object) {
        return 0xff;
    }
...
int
plist_object_primitive_get_value(const plist_object_t *object, uint8_t *value)
{
    if (!object || !value) {
        return -1;
    }
...
int
plist_object_integer_get_value(const plist_object_t *object, int64_t *value)
{
    if (!object || !value) {
        return -1;
    }
...
int
plist_object_real_get_value(const plist_object_t *object, double *value)
{
    if (!object || !value) {
        return -1;
    }
...
int
plist_object_string_get_value(const plist_object_t *object, const char **value)
{
    if (!object || !value) {
        return -1;
    }
...
plist_object_array_get_value(const plist_object_t *object, uint32_t idx)
{
    if (!object) {
        return NULL;
    }
...
const plist_object_t *
plist_object_dict_get_value(const plist_object_t *object, const char *key)
{
    int i;
...
//		return;
//	}
//	intobj = (plist_object_t *)plist_object_dict_get_value(object, "integer");
