 ...
 */
public class APSDownloadTracker implements DownloadManager.Listener {
    ...
    private static final String TAG = "APSDownloadTracker";
    ...
    public APSDownloadTracker(
        ...
        HandlerThread actionFileWriteThread = new HandlerThread("APSDownloadTracker");
    ...
    private void startServiceWithAction(DownloadAction action) {
        DownloadService.startWithAction(context, APSDownloadService.class, action, false);
    }
    ...
    private final class StartDownloadDialogHelper
        ...
        public StartDownloadDialogHelper(
            ...
            dialogView = dialogInflater.inflate(R.layout.activity_download_dialog, null);
