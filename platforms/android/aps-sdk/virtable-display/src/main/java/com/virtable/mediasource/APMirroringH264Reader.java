...
public class APMirroringH264Reader implements ElementaryStreamReader {
   ...
   */
  public APMirroringH264Reader(boolean allowNonIdrKeyframes, boolean detectAccessUnits) {
  ...
  public void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator idGenerator) {
    ...
    sampleReader =
        new APMirroringH264Reader.SampleReader(output, allowNonIdrKeyframes, detectAccessUnits);
  }
      ...
      if (!hasOutputFormat) {
        if (sps.isCompleted() && pps.isCompleted()) {
          ...
          NalUnitUtil.SpsData spsData =
              NalUnitUtil.parseSpsNalUnit(sps.nalData, APMirroringNalUnitTargetBuffer.START_CODE_LENGTH, sps.nalLength);
          NalUnitUtil.PpsData ppsData =
              NalUnitUtil.parsePpsNalUnit(pps.nalData, APMirroringNalUnitTargetBuffer.START_CODE_LENGTH, pps.nalLength);
          output.format(
  ...
  private static final class SampleReader {
    ...
    private APMirroringH264Reader.SampleReader.SliceHeaderData previousSliceHeader;
    private APMirroringH264Reader.SampleReader.SliceHeaderData sliceHeader;
    ...
    public SampleReader(TrackOutput output, boolean allowNonIdrKeyframes,
      ...
      sps = new SparseArray<>();
      pps = new SparseArray<>();
      previousSliceHeader = new APMirroringH264Reader.SampleReader.SliceHeaderData();
      sliceHeader = new APMirroringH264Reader.SampleReader.SliceHeaderData();
    ...
    public void startNalUnit(long position, int type, long pesTimeUs) {
      ...
      if ((allowNonIdrKeyframes && nalUnitType == NAL_UNIT_TYPE_NON_IDR)
        ...
        APMirroringH264Reader.SampleReader.SliceHeaderData newSliceHeader = previousSliceHeader;
    ...
    private static final class SliceHeaderData {
      ...
      private boolean isFirstVclNalUnitOfPicture(APMirroringH264Reader.SampleReader.SliceHeaderData other) {
