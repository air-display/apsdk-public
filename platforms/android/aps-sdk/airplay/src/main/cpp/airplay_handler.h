...
public:
  ...
  void on_video_scrub(const std::string &session,
                      const float position);

  void on_video_rate(const std::string &session,
                     const float value);

  void on_video_stop(const std::string &session);

  void on_acquire_playback_info(const std::string &session,
